...
remote_exec hashicups-db "bash ${WORKDIR}start_hashicups_db.sh" > /dev/null 2>&1
...
remote_exec hashicups-api "bash ${WORKDIR}start_hashicups_api.sh" > /dev/null 2>&1
...
remote_exec hashicups-frontend "bash ${WORKDIR}start_hashicups_fe.sh" > /dev/null 2>&1
