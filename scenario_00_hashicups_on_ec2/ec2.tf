...
resource "aws_instance" "database" {
  ...
  provisioner "file" {
    content = templatefile("${path.module}/scripts/start_hashicups_db.sh.tmpl", {
...
resource "aws_instance" "api" {
  ...
  ## Start Main Application
  provisioner "file" {
    content = templatefile("${path.module}/scripts/start_hashicups_api.sh.tmpl", {
...
resource "aws_instance" "frontend" {
  ...
  ## Start Main Application
  provisioner "file" {
    content = templatefile("${path.module}/scripts/start_hashicups_fe.sh.tmpl", {
...
resource "aws_instance" "nginx" {
  ...
  ## Start Main Application
  provisioner "file" {
    content = templatefile("${path.module}/scripts/start_hashicups_nginx.sh.tmpl", {
